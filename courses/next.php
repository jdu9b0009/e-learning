  ...
  <section id="about">
      <div class="container">
          ...
          <p>
                ...
                The copyright and trademarks for Next.js are owned by Vercel, which 
                also maintains and leads its open-source development.
          </p>
      </div>
  </section>
  ...
  <section id="courses">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 1">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 3">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 4">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 5">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 6">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 7">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 8">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course2.jpg" class="card-img-top" alt="Course 9">
            <div class="card-body">
