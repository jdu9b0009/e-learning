...
<body>
  ...
  <div class="container" style="padding-top: 15px;">
    ...
    <!-- <a class="navbar-brand" href="../home.php">e-Learning Platform</a> -->
  ...
  <section id="about">
      <div class="container">
          <h2>What is React.js?</h2>
            ...
            <p>
                In React, you develop your applications by creating reusable components 
                that you can think of as independent Lego blocks. These components are 
                individual pieces of a final interface, which, when assembled, form the 
  ...
  <section id="courses">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course1.jpg" class="card-img-top" alt="Course 2">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course1.jpg" class="card-img-top" alt="Course 4">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course1.jpg" class="card-img-top" alt="Course 5">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course1.jpg" class="card-img-top" alt="Course 6">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course1.jpg" class="card-img-top" alt="Course 7">
            <div class="card-body">
              <h5 class="card-title8">Lesson 7</h5>
              <a href="../lessons/lesson.php" class="btn btn-primary">view lesson</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course1.jpg" class="card-img-top" alt="Course 8">
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="../images/course1.jpg" class="card-img-top" alt="Course 9">
            <div class="card-body">
